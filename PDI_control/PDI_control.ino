...
#define PIN_IR A0  
#define IR_PIN A0  // [20213077] analong 핀 정의 
...
#define _DUTY_MAX 1900         // [20213079] 서보 duty 최댓값
...
float dist_raw, dist_ema, dist;    // [20213077] 측정값, ema필터 적용값
...
dist_raw = dist_ema = dist= ir_distance();
